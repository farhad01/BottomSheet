...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/jebelli.farhad@gmail.com/BottomSheet'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'jebelli.farhad@gmail.com' => 'jebelli.farhad@gmail.com' }
  s.source           = { :git => 'https://github.com/jebelli.farhad@gmail.com/BottomSheet.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'BottomSheet' => ['BottomSheet/Assets/*.png']
  # }
